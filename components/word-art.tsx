    ...
    return (
      <div className="flex items-center justify-center bg-zinc-900">
        <motion.h1
          ...
          className="text-[8rem] font-extrabold text-transparent bg-clip-text bg-gradient-to-r from-gray-500 to-gray-200 relative"
        >
          <span className="absolute left-0 top-0 text-[8rem] font-extrabold text-gray-500 drop-shadow-[0_0_5px_rgba(158,158,158,0.8)]">
            Pro
          </span>
          <span className="absolute left-0 top-0 text-[8rem] font-extrabold text-gray-200 drop-shadow-[0_0_15px_rgba(238,238,238,0.6)]">
            Pro
          </span>
