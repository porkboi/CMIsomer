    ...
    return (
      ...
      >
        <div className="relative z-20">
          {/* This wrapper acts like a mask */}
          <div className="relative inline-block text-transparent bg-clip-text bg-gradient-to-r from-pink-500 to-purple-700">
            {/* Glow light that follows the mouse, only visible through text */}
            {isHovering && (
              <div
            ...
            <motion.h1
              ...
              animate={{ opacity: 1, scale: 1 }}
              transition={{ duration: 0.6 }}
              className="relative z-20 text-[7rem] font-extrabold"
            >
